...
functionality:
    ...
    info:
      ...
      slots:
        ...
        - description: 'Differential expression value (`-log10(p-value) * sign(LFC)`)
            ...
            and control condition after shrinkage as calculated by Limma. Positive
            LFC means
        ...
        - description: A unique identifier for the dataset. This is different from
            the `obs.dataset_id` field, which is the identifier for the dataset from
            which the cell data is derived.
          name: dataset_id
          required: true
          type: string
  ...
  - __merge__: file_prediction.yaml
    direction: output
    example: resources/neurips-2023-data/prediction.h5ad
    info:
      file_type: h5ad
      label: Prediction
      slots:
...
```
    ...
    [1] "/tmp/Rtmp9KxQOJ/task_perturbation_prediction"
